...
/* Moment Matching SMC for ABC inference using the generalised logistic growth 
 * model for the approximate model and final target of the the hexagonal lattice model 
...
main(int argc, char ** argv)
{
    ...
    if (argc  < (9 + 2*m))
    {
        fprintf(stderr,"Usage: %s filename N s eps T Pm I J [sl1,sl2,...slm,su1,su2,sum] \n",argv[0]);
        exit(1);
    }
    else
    {
    ...
    /*generate posterior samples using Moment Matching ABC-SMC*/
    start_t = clock();
